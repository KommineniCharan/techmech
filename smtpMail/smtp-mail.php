...
CURLOPT_POST => true,
CURLOPT_POSTFIELDS => [
'secret' => '6Ld-ZYwhAAAAAJ2rdedFmt9J2bQp2C8cCCsm_L9f',
'response' => $_POST["token"],
...
echo "Captcha Verification Failed";
        ...
        try {
            ...
            $mail->SMTPSecure = 'tls';
            $mail->SMTPAuth = true;
            $mail->Username = 'webleadsgrank@gmail.com';
            $mail->Password = 'ecjvbdekrjxbttww'; // Be sure to protect sensitive info
            $mail->setFrom('webleadsgrank@gmail.com', 'TD-G Rank-Enquiry');
    //   $mail->AddAddress('info@techmechcranes.com', 'TechMech Cranes');
    //     $mail->AddAddress('techmechsales11@gmail.com', 'TechMech Cranes');
    //     $mail->AddBCC('seo.grank@gmail.com', 'TechMech Cranes ');
    //     $mail->AddBCC('anjali@grank.co.in', 'TechMech Cranes ');
    //             $mail->AddBCC('vineeth@grank.co.in', 'TechMech Cranes ');
     $mail->addAddress('udayaravind@grank.co.in', 'Placeholder Company');
     	$mail->addBCC('prashanth@grank.co.in', 'Placeholder Company');
            ...
            // Optional: set debugging for email issues
            // $mail->SMTPDebug = 2;
